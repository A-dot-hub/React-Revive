 ...
 const [color,setColor]=useState("olive")
  ...
  return (
    ...
    style={{backgroundColor: color}}>
      <div className="fixed flex-wrap justify-items-center-center bottom-12 inset-x-0 px-2">
      <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
        ...
        <button onClick={()=>setColor("lightcyan")} className="outline-none px-4  py-1 rounded-full text-black shadow-lg"style={{backgroundColor: "lightcyan"}}>Lightcyan</button>
